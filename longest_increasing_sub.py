class LIS:
	...
	Attributes:
		L : the input list. This can be either numbers or strings. For the 
		case where the input list is a string with mixed lowercase and uppercase
		letters, we consider uppercase letters to come before lowercase letters.
	"""
